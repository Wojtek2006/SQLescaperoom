    ...
    <main class="container">
        ...
        <section>
            <div class="home_content">
                <h2>Zadanie 3</h2>
                <p class="task_sm">Wprowadź zapytanie do tabeli kierowcy, którego wynikiem będą wszystkie osoby wypisane alfabetycznie po nazwisku.</p>
                <form action="scripts/task3_script.php" method="POST">
