    ...
    <main class="container">
        ...
        <section>
            <div class="home_content">
                <h2>Zadanie 4</h2>
                <p class="task_sm">Wprowadź zapytanie do tabeli taryfikator, którego wynikiem będzie suma cen wszystkich wykroczeń.</p>
                <form action="scripts/task4_script.php" method="POST">
