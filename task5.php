    ...
    <main class="container">
        ...
        <section>
            <div class="home_content">
                <h2>Zadanie 5</h2>
                <p class="task_sm">Wprowadź zapytanie do tabeli kierowcy, którego wynikiem będą kierwocy z nr. rejestracyjnym zaczynającym się na literę D.</p>
                <form action="scripts/task5_script.php" method="POST">
